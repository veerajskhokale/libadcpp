...
class ForwardIterator {
  ...
  public:
    ...
    VisitorType visitor() const { return mCur; }

    Reference operator*() const { return *mCur; }

    Pointer operator->() const { return mCur.operator->(); }
...
inline Bool operator==(
    const ForwardIterator<Visitor1, Tag>& l,
...
class BidirIterator {
  ...
  public:
    ...
    inline static IterType end(VisitorType v) {
        ...
        return e ? IterType(e, false)
                 : IterType(_iterator::last(v, Tag{}), true);
    }

    template<class Visitor1, class Visitor2, class Tag_>
    friend inline Bool operator==(
        const BidirIterator<Visitor1, Tag_>& l,
...
template<class ForwardVs>
using ChildIterator =
    _iterator::ForwardIterator<ForwardVs, _iterator::ChildTag>;

template<class BidirVs>
using BidirChildIterator =
    _iterator::BidirIterator<BidirVs, _iterator::ChildTag>;

template<class ParentVs>
using ParentIterator =
    _iterator::ForwardIterator<ParentVs, _iterator::ParentTag>;
